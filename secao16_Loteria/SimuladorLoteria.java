 ...
 * 
 * Após registrar os bilhetes, para cada bilhete, chmae o método realizarSorteio.
...
public class SimuladorLoteria {
    public static void main(String[] args) {
        ...
        // Solicitando bilhetes para usuario
        while(true){
            ...
            // Pergunta se o usuario quer sair
            System.out.print("Deseja registrar outro bilhete? (S/N): ");
