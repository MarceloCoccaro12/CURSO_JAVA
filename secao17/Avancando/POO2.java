...
public class POO2 {
    public static void main(String[] args) {
        ...
        // classe final final - nao pode ser herdada
        // metodo final - nao pode ser sobreescrito

        // 2 - Reflection API
        
        try {
            Class<?> classePessoa = Class.forName("secao17.Avancando.Pessoa");
